...
### Workflows
#### [DELETE] [ci.yml](file:///home/jgfurlan/dev/projects/neurotask-agent/.github/workflows/ci.yml)
Remove bad Java CI.

#### [NEW] [ci-cd.yml](file:///home/jgfurlan/dev/projects/neurotask-agent/.github/workflows/ci-cd.yml)
...
### Environment
#### [MODIFY] [docker-compose.yml](file:///home/jgfurlan/dev/projects/neurotask-agent/docker-compose.yml)
Remove hardcoded DB creds. Use `.env` vars.

#### [NEW] [.env.example](file:///home/jgfurlan/dev/projects/neurotask-agent/.env.example)
